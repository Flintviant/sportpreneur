...
- Create a [Github Release](https://github.com/REMOVED/midtrans-php/releases) with the target version
- Github Release and Master Branch is automatically synced to [the Packagist version](https://packagist.org/packages/midtrans/midtrans-php)
  ...
  - To edit integration config sign in with the REMOVED Packagist Account
